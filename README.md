...
| name | description |
|------|---------------|
| [`code-with-coco`](https://github.com/cocohernandez/code-with-coco/tree/main) | an accompaniment to my video series where i build random little tools, and show how anyone can too |
